...
#ifndef FICTIONBOOK2METADATACOLLECTOR_H_INCLUDED
#define FICTIONBOOK2METADATACOLLECTOR_H_INCLUDED
...
class FictionBook2MetadataCollector : public FictionBook2Collector
{
public:
...
#endif // FICTIONBOOK2METADATACOLLECTOR_H_INCLUDED
